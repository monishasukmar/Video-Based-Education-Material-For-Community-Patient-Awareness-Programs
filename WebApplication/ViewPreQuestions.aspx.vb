...
Public Class WebForm5
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        con.Open()
        Dim com As New MySqlCommand(String.Format("select * from quiz where CourseCode='{0}';", Session("selid")), con)
    ...
    Public Sub delrecord(sender As Object, e As EventArgs)
        ...
        Dim com As New MySqlCommand(String.Format("delete from quiz where q_no='{0}'", ll.Attributes("ide1")), con)
        com.ExecuteNonQuery()
        con.Close()
        Response.Redirect("ViewPreQuestions.aspx")
    End Sub
    ...
    Public Sub editrecord(sender As Object, e As EventArgs)
        ...
        Session("eid") = id
        Response.Redirect("EditPreQuestions.aspx")
    End Sub
