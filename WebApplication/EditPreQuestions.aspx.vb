...
Public Class WebForm13
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        con.Open()
        Dim com As New MySqlCommand(String.Format("select * from quiz where q_no='{0}'", Session("eid")), con)
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        con.Open()
        Dim str As String
        str = "update quiz set Questions=@q1, Op1=@o1, Op2=@o2, Op3=@o3, Op4=@o4, Ans=@a1 where q_no=@qno;"
